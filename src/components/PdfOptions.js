          ...
          <div className="mt-6">
            <ul className="space-y-4">
              {documentList.map((doc, index) => (
                <li key={index} className="flex justify-between items-center p-4 bg-gray-100 rounded-lg border border-gray-300 hover:bg-gray-200 transition duration-200">
                  <span className="truncate flex-1 mr-4">{truncateFilename(doc.pathFile)}</span>
                  <button
